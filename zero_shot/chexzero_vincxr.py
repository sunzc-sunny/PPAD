...
from ppad_clip.datasets.vincxr import VinCXR
import numpy as np
...
# test dataset path
dataset = VinCXR('', train=False)

testloader = torch.utils.data.DataLoader(dataset, batch_size=1024, shuffle=True, num_workers=0)
