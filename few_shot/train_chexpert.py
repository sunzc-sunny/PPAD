...
test_dataset = MaskZhangTrain('/data/sunzc/chexpert/our_test_256_pa', train=False, transforms=test_transform)
train_dataset = MaskZhangTrain('/data/sunzc/chexpert/train_256_pa', mypseudo=True, train=True, transforms=train_transform, shot=64, prob=0.5)
...
trainloader = torch.utils.data.DataLoader(train_dataset, batch_size=128, shuffle=True, num_workers=32)
