...
# train dataset path
train_dataset = MaskZhangTrain('./chexpert/train_256_pa', mypseudo=True, train=True, transforms=train_transform, shot=64, prob=0.5)

# test dataset path
test_dataset = MaskZhangTrain('./chexpert/our_test_256_pa', train=False, transforms=test_transform)
